...
rg -Fq 'install -d -o ubuntu -g ubuntu -m 0775 "$native_root" "$native_root/mysql" "$native_root/redis" "$native_root/meilisearch" "$native_root/images" "$native_root/edge"' "$INSTALLER"
