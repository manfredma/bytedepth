...
bash "$SOURCE_ROOT/scripts/test-project-ownership.sh"
bash "$SOURCE_ROOT/scripts/test-staging-native-stack.sh"
bash "$SOURCE_ROOT/scripts/test-host-native-deployment.sh"
bash "$SOURCE_ROOT/scripts/test-production-red-green-rehearsal.sh"
bash "$SOURCE_ROOT/scripts/test-host-native-docs.sh"
bash "$SOURCE_ROOT/scripts/test-host-native-data-migration.sh"
