...
readonly FIXTURE_NATIVE_CONFIG="$FIXTURE_ROOT/staging-native.conf"
...
BYTEDEPTH_NATIVE_REDIS_PORT=16379
BYTEDEPTH_NATIVE_MEILI_PORT=17700
BYTEDEPTH_NATIVE_APP_PORT=18080
BYTEDEPTH_NATIVE_EDGE_PORT=18081
EOF
}
